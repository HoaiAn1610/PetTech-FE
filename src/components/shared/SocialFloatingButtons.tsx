...
export function SocialFloatingButtons() {
  return (
    <div
      className="fixed z-[500] flex flex-col gap-3"
    ...
    >
      ...
      <a
        ...
        title="Chat on Zalo"
        className="w-12 h-12 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:-translate-y-1 shadow-lg"
        style={{
      ...
      >
        <span style={{ color: "white", fontSize: "1.1rem", fontWeight: 900, fontFamily: "Inter, sans-serif" }}>Z</span>
      </a>
