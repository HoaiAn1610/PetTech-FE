  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: "rgba(37,99,235,0.08)" }}>
        <ScrollText className="w-8 h-8" style={{ color: "#2563EB" }} />
      </div>
      <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#111827" }}>Nhật ký hoạt động</h3>
      <p style={{ fontSize: "0.82rem", color: "#9ca3af", textAlign: "center", maxWidth: 360 }}>
        Tính năng này đang được phát triển. API nhật ký hoạt động sẽ sớm được tích hợp.
      </p>
